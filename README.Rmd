...
Note: On the first run of each R session, the function may take a few seconds to execute as the package checks which WEO publication is currently the latest. This information is put into a cache that is reset whenver your session restarts. 
...
To list the available entities (countries or regions) for the latest publication:
